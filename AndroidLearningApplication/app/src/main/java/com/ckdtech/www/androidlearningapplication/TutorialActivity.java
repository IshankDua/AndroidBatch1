...
public class TutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StorageReference riversRef = mStorageRef.child(tutorialFileName);

        book = (PDFView) findViewById(R.id.pdfPage1);
        try {
            final File localFile = File.createTempFile(tutorialName, ".pdf");
            riversRef.getFile(localFile)
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    // ...
                    Toast.makeText(TutorialActivity.this, "Error showing Tut", Toast.LENGTH_SHORT).show();
                }
            });
